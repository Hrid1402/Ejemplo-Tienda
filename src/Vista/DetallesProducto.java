...
public class DetallesProducto extends javax.swing.JFrame {
    ...
    private void setUpInformation(){
        ...
        //renderImage:
        try {
            // 1. Define la URL de la imagen. (Esto no cambia)
            ...
            // B. Calcula las nuevas dimensiones manteniendo la proporción.
            int newWidth = originalWidth;
            int newHeight = originalHeight;

            // Comprueba si la imagen es proporcionalmente más ancha que el contenedor.
            if ((double) originalWidth / originalHeight > (double) containerWidth / containerHeight) {
                // Si es más ancha, el ancho es el límite. La nueva altura se calcula para mantener la proporción.
                newWidth = containerWidth;
                newHeight = (newWidth * originalHeight) / originalWidth;
            } else {
                // Si es más alta (o tiene la misma proporción), la altura es el límite. El nuevo ancho se calcula.
                newHeight = containerHeight;
                newWidth = (newHeight * originalWidth) / originalHeight;
            }
            Image scaledImage = originalImage.getScaledInstance(newWidth, newHeight, Image.SCALE_SMOOTH);

            // 4. Coloca la imagen escalada en el JLabel. (Esto no cambia)
            ImageRenderer.setIcon(new ImageIcon(scaledImage));

        } catch (Exception e) {
            e.printStackTrace();
            // Si algo falla, muestra un mensaje. (Esto no cambia)
